...
namespace Dirichlet.Ad.Samples
{
    ...
    /// Only activates when the demo scene is loaded.
    /// </summary>
    internal static class DirichletDemoBootstrap
    {
        private const string DemoSceneName = "DirichletAdDemo";
        private const string DemoSceneFileName = "DirichletAdDemo.unity";
