...
public class MilitaryManager : SingleMonoAutoBehavior<MilitaryManager>//枪械管理
{
    ...
    public GunType GetGunType(string GunName)
    {
        ...
        /* Debug.LogError($"[MilitaryManager] GetGunType：未找到名为 {GunName} 的枪械信息，无法获取类型"); */
        return GunType.Rifle;//默认返回步枪类型，实际使用中请根据需要调整
    }
...
//   public List<BulletInfo> BulletInfoList;//该枪械类型对应的子弹信息列表
//}
